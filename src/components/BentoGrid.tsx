...
export const BentoGrid: React.FC<BentoGridProps> = ({
  ...
  const progressPercent = Math.min(100, Math.round((todayTotal / (dailyGoal || 1)) * 100));
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.topLargeCard}>
        ...
        {/* Valor Gasto no Dia */}
        <Text style={styles.totalValue}>{formatCurrency(todayTotal, currency)}</Text>
        ...
        <View style={styles.goalRow}>
          <View style={styles.goalLeft}>
            ...
            >
              {isOverGoal
                ? `+${formatCurrency(todayTotal - dailyGoal, currency)} acima`
            ...
            {categorySegments.map((segment) => (
              <View key={segment.id} style={styles.legendItem}>
                ...
                <Text style={styles.legendText}>
                  {segment.name} ({formatCurrency(segment.total, currency)})
                </Text>
              </View>
            ))}
          </View>
        ...
        >
          <View style={styles.smallCardHeader}>
            <View style={styles.monthBadge}>
              <Ionicons name="wallet-outline" size={14} color={isDark ? colors.primary : colors.textPrimary} />
          ...
          <View style={styles.smallCardContent}>
            <Text style={styles.monthTotalValue}>{formatCurrency(monthTotal, currency)}</Text>
